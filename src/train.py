...
if __name__ == '__main__':
    ...
    parser.add_argument("--min_freq", type=int, default=3, help="Minimum frequency for vocab (was 1, filtering rare words helps generalization)")
    ...
    n_trials_optuna = 1 # Reduced trials for example run, increase for thorough tuning
