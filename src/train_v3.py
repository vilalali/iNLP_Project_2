...
def train_model(model, train_loader, val_loader, epochs, learning_rate, model_type, model_name, patience=3, device=None, multi_gpu=False, vocab=None, word_to_index=None, best_params = None, n_gram = None):
    ...
    model_dir = args.model_dir  # Use the model_dir argument
    save_path = os.path.join(model_dir, f'{model_name}_final_model.pth')
    if model_type == 'ffnn':
